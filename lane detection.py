...
def process_image(image):
    ...
    window_width = 30
    window_height = 80
    curve_centers = tracker(Mywindow_width=window_width,Mywindow_height=window_height,Mymargin=10,My_ym=10/720,My_xm=4/384,Mysmooth_factor=15)
...
if __name__=="__main__":
    ...
    froze_file = 'frozen_inference_graph.pb'

    model = cv2.dnn_DetectionModel(froze_file, config_file)
    ...
    input_vid = 'output_vid/project_short.mp4'
    output_vid = 'output_vid/lane_tracker2.mp4'

    cam = cv2.VideoCapture(input_vid)
    cv2.namedWindow("Object Detection", cv2.WINDOW_NORMAL)
    cv2.resizeWindow("Object Detection", 1000,500)
    while cam.isOpened():
        ret, frame = cam.read()
